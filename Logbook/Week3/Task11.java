...
public class Task11 {
    ...
    public static class Task11 {
        ...
        public static class Student {
            private int id;
            private String name;
            private Logbook.Week3.Task11.Course course; // Added Course attribute
            ...
            public Logbook.Week3.Task11.Course getCourse() {
                return course;
            }

            public void setCourse(Logbook.Week3.Task11.Course course) {
                this.course = course;
            }

            public void enrol(Logbook.Week3.Task11.Course course){ //enrol method added.
                this.course = course;
            }
        ...
        public static void main(String[] args) {
            // Test: Instantiate Course class
            Logbook.Week3.Task11.Course myActualCourse = new Logbook.Week3.Task11.Course("COMP101", "Introduction to Computer Science");

            // Student object
            Logbook.Week3.Task11.Student myStudent = new Logbook.Week3.Task11.Student(87654321, "TestName"); // Simplified student creation
            ...
            Logbook.Week3.Task11.Student studentWithoutCourse = new Logbook.Week3.Task11.Student(100162245, "NoCourseStudent");
            System.out.println("\nTesting Student with no course:");
            studentWithoutCourse.print();
        }
